...
def MetodoHillDesencryptar(alfabeto, mensajeEncryptado):
    K = [
        [3, 5, -2],
        [1, 3, -1],
        [-2, -5, 2],
...
def menuHill():
    ...
    if y == '0':
        ...
        os.system('cls')
        print('Funcion Encriptar')
        mensaje = input("Escribe la palabra a encriptar debe tener solo 6 letras : \n")
        mensaje = mensaje.upper()
        if len(mensaje) != 6:
            print("Especificaciones incorrectas")
            menuHill()
        else:
        ...
        os.system('cls')
        print('Funcion Desencriptar')
        mensajeEncryptado = input("Ingrese el mensaje a decifrar debe tener solo 6 letras): \n")
        mensajeEncryptado = mensajeEncryptado.upper()
        if len(mensajeEncryptado) != 6:
            print("Especificaciones incorrectas")
            menuHill()
        else:
